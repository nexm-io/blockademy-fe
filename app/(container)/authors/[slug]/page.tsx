...
const AuthorDetail = () => {
  ...
  const authorPost = useAppSelector((state) => state.author.data);
  console.log("AuthorDetail ~ authorProfile:", authorPost);
      ...
      <div className="flex gap-6 justify-between">
        ...
        <div className="w-[325px] h-full rounded-lg mt-8 basis-[325px]">
            ...
            <div className="flex gap-2 flex-col ">
              ...
              <div className="flex gap-4">
                <p className="text-sm font-normal leading-5 text-gray-300">
                  Posts: <span className="text-black-100 font-medium">154</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col mt-10 gap-6 p-6 rounded-lg bg-gray-400 bg-opacity-20">
            ...
            <div className="flex gap-4 items-center relative other__authors--underline">
