  ...
  return (
    <div className="mt-24 sm:mt-32">
      ...
      <div className="block lg:hidden">
        <Collapse
          accordion
          className="leaderboard mb-1 rounded-none bg-[#F8F8F8]"
          defaultActiveKey={""}
          items={[
            {
              children: (
          ...
          <tbody>
            ...
            >
              <td className="px-0">
                <div
                  className={cn(
                    `h-12 py-1 flex items-center justify-end bg-[#F8F8F8] group-hover:bg-opacity-50 gap-2 transition-all`,
                  )}
                >
                  <Medal className="text-[#FBD101]" />
                </div>
              ...
              <td className="px-0">
                <div
                  className={cn(
                    "py-1 h-12 justify-center bg-[#F8F8F8] group-hover:bg-opacity-50 transition-all flex items-center"
                  )}
                >
                  1
                </div>
              ...
              <td className="px-0">
                <div
                  className={cn(
                    `h-12 py-1 flex items-center gap-5 bg-[#F8F8F8] group-hover:bg-opacity-50 transition-all line-clamp-1`
                  )}
                >
              ...
              <td className="px-0">
                <div
                  className={cn(
                    `h-12 py-1 flex items-center justify-center bg-[#F8F8F8] group-hover:bg-opacity-50 transition-all`
                  )}
                >
                  54
                </div>
              ...
              <td className="px-0">
                <div
                  className={cn(
                    `h-12 py-1 flex items-center justify-center bg-[#F8F8F8] group-hover:bg-opacity-50 transition-all cursor-pointer hover:opacity-80`
                  )}
                >
                  Apr 26, 2023   6:05
                </div>
            ...
            >
              ...
              <td className="px-0">
                <div
                  className={cn(
                    `h-12 py-1 flex items-center justify-center bg-[#E1FAFF] text-[#1F5AB3] font-bold group-hover:bg-opacity-50 transition-all cursor-pointer hover:opacity-80`
                  )}
                >
                  Apr 26, 2023   6:05
                </div>
