...
const JourneyAcademy = () => {
  ...
  return (
    <section className="w-full mt-10 md:mt-16 lg:mt-36 bg-blue-200 px-12 py-14 rounded-[20px]">
      ...
      <div className="flex items-center gap-5 justify-between mt-14">
        {/* Item 1 */}
        <div className="p-8 bg-blue-300 flex items-center flex-col justify-center gap-2 rounded-[20px]">
